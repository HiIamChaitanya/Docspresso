...
static_assert(
    ...
    "type rust::cxxqt1::QMetaObjectConnection should be trivially move constructible and trivially destructible in C++ to be used as a return value of `qmetaobjectconnection_default` or non-pinned mutable reference in signature of `qmetaobjectconnection_drop` in Rust");

namespace rust {
namespace cxxqt1 {
extern "C" {
void rust$cxxqt1$cxxbridge1$qmetaobjectconnection_default(::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
bool rust$cxxqt1$cxxbridge1$qmetaobjectconnection_disconnect(::rust::cxxqt1::QMetaObjectConnection const &connection) noexcept {
...
void rust$cxxqt1$cxxbridge1$qmetaobjectconnection_drop(::rust::cxxqt1::QMetaObjectConnection &connection) noexcept {
